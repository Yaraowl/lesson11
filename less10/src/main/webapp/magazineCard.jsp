...
<head>
    ...
    <title>Online magazine shop- Magazine "${magazine.title}"</title>
</head>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Subscribe period:<br>
                            <input class="subscribePeriod" type="number" max="12" min="1" value="1"> month</p>

                            <button type="button" class="btn btn-primary openModal" data-toggle="modal" data-target="#buyMagazineModal">Add to bucket</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Subscribe "${magazine.title}"</h5>
                        ...
                        <script language="javascript">var subscribePeriod = $('.subscribePeriod').val()</script>
                            Are you sure yo wat add subscription for <span id="subscribePeriod"></span> month. on magazine "${magazine.title}" to the bucket?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cansel</button>
                            <button type="button" magazineID="${magazine.id}" class="btn btn-primary buy-magazine">Add to bucket</button>
                        </div>
                    </div>
                </div>
            </div>
